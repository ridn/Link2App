--[[
     all URLs were discovered by digging through Vine's page source ;P
          -ridn
]]
...
return function(url)
 ...
 -user, tw/user, user-id  all function the same from what i can tell?
 ...
 -there are some more URLs but i encountered they dont seem to do anything, so i wont bother listing them
